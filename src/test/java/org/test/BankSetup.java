...
public class BankSetup extends Base{
	...
	public void TC11() {
		...
		String bank=PropertyFileReader.propertymap.get("Accountname");
		loginaction.login(LoginID, Password);
		bankactions.bs11(wb,locaName,bank);
	}
	...
	public void TC12() {
		...
		loginaction.login(LoginID, Password);
		bankactions.bs12(wb,locaName,bank);
	...
	public void TC15() {
		String LoginID=PropertyFileReader.propertymap.get("loginid");
		String Password=PropertyFileReader.propertymap.get("password");
		String accnam1=PropertyFileReader.propertymap.get("Authorize.Net");
