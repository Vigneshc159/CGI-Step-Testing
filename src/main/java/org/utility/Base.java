...
public class Base extends PropertyFileReader{
	...
	public void launch() throws IOException {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\Administrator\\Downloads\\CGI (3)\\chromedriver.exe");
	//	WebDriverManager.chromedriver().setup();
		
		 wb=new ChromeDriver();
		
		wb.get("https://www.hedgeonline.us/CGI/Views/Loginpage.aspx?");
